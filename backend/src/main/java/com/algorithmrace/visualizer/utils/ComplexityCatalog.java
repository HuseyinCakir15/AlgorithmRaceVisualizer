...
public final class ComplexityCatalog {
    ...
    static {
        ...
        add("Shell Sort", "O(n log n)", "O(n^1.3)", "O(n^2)", "O(1)", "Improves Insertion Sort by comparing and shifting elements at a shrinking gap before finishing with gap one.", "gap = n / 2\nwhile gap > 0:\n  insertion sort with step size gap\n  gap = gap / 2");
